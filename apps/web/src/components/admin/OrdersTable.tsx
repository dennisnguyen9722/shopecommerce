  ...
  return (
    <div className="space-y-4">
      ...
      {!isLoading && list.length === 0 ? (
        <div className="p-6 text-center text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800">
        ...
        list.map((o: OrderType) => {
          ...
          return (
            <div
              ...
              className="p-4 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm cursor-pointer hover:shadow-md dark:hover:bg-gray-800/50 transition"
            >
